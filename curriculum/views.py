...
from .models import Assignment, Standard, Subject, Lesson, Comment
#  WorkingDays, TimeSlots
from django.urls import reverse_lazy
from .forms import AssignmentForm, CommentForm,ReplyForm, LessonForm
...
#     course = Lesson.objects.get(id=pk)
#     if form.is_valid():
...
#     return render(request, 'curriculum/lesson_detail_view.html')
...
def viewAssignmentById(request, id):
	context = {
		 'items': Assignment.objects.filter(course = id),
	}
	return render(request, 'curriculum/assignment.html', context)
