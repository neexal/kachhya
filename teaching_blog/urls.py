...
admin.site.site_header = 'eSchool Dashboard'                   
admin.site.index_title = 'Welcome to eSchool Dashboard'  
admin.site.site_title = 'eSchool Dashboard' 
...
urlpatterns = [
    ...
    path('assignment/<int:id>/', views.AssignmentDetail.as_view),
